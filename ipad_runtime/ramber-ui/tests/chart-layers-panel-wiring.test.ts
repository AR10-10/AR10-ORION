...
describe('App.tsx: estado real do painel + toggle por camada, compartilhado via contextValue', () => {
  ...
  it('CHART_LAYER_PANEL_MODULES lista exatamente as 24 camadas reais, cada id um ChartLayerId válido (o próprio TypeScript trava isso — este teste só confirma que a lista não encolheu/cresceu silenciosamente)', () => {
    const app = read('../src/App.tsx');
